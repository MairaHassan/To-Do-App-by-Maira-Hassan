...
useEffect(()=>{
  ...
  return (
    <div className='bg-purple-600 place-self-center w-11/12 max-w-md flex 
    flex-col p-7 min-h-[550px] rounded-xl outline-double'>
...
{/* -----input box------- */}
    ...
    <div className='flex items-center my-7 bg-gray-200 rounded-full'>
        ...
        <button onClick={add} className='border-none rounded-full bg-pink-400 w-32 h-14 text-white 
